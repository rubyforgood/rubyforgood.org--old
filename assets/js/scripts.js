(function() {
  ...
  $(function() {
    ...
    $('#mobileheader li.dropdown [data-toggle="dropdown"]').on(
      "click",
      function(e) {
        e.stopPropagation();
        e.preventDefault();
  ...
  mapboxgl.accessToken =
    "pk.eyJ1Ijoia2FsaW1hciIsImEiOiJjamZwZjI3eG4xMWcwMnFwZXlmeWlpZjYxIn0.x4tB7Pictd1bEOFDtBUolQ";

  var map = new mapboxgl.Map({
    container: "canvas-map",
    style: "mapbox://styles/kalimar/cjfjpo6ioa9vg2slg1pjbxt78",
    center: [-77.307345, 38.831382],
    zoom: 16
  });
